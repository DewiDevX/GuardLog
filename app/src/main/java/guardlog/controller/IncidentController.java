...
public class IncidentController implements Initializable {
    ...
    // Hapus ObservableList<Incident> incidents = FXCollections.observableArrayList();
    // Gunakan IncidentManager
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        // Set TableView items dari IncidentManager singleton
        incidentTable.setItems(IncidentManager.getInstance().getIncidents());
        System.out.println("IncidentController: TableView diatur. Jumlah item di TableView: " + incidentTable.getItems().size()); // Debug
    ...
    private void handleCreateIncident() {
        ...
        try {
            ...
            IncidentManager.getInstance().addIncident(newIncident); // Tambahkan melalui Manager
