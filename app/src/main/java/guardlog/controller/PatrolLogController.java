...
public class PatrolLogController implements Initializable {
    ...
    // Hapus ObservableList<PatrolLogEntry> patrolEntries = FXCollections.observableArrayList();
    // Gunakan PatrolLogManager
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        // Set TableView items dari PatrolLogManager singleton
        patrolLogTable.setItems(PatrolLogManager.getInstance().getPatrolEntries());
        System.out.println("PatrolLogController: TableView diatur. Jumlah item di TableView: " + patrolLogTable.getItems().size()); // Debug
    }
    ...
    private void handleRecordPatrol() {
        ...
        PatrolLogManager.getInstance().addPatrolEntry(newEntry); // Tambahkan melalui Manager
